...
const OnboardModal = () => {
  ...
  const { updateCurrentWalletAddress, isPlayerRegistered } = useGlobalContext();
  ...
  return (
    ...
    >
      {!isPlayerRegistered && !isHomePage ? (
        <>
          <p className={styles.modalText}>Oops, you are not registered</p>
          <CustomButton
            title="Register"
